...
public final class MediaContent   implements java.io.Serializable, com.dslplatform.client.json.JsonObject {
	...
	@com.fasterxml.jackson.annotation.JsonCreator private MediaContent(
			@com.fasterxml.jackson.annotation.JsonProperty("_helper") final boolean _helper ,
			@com.fasterxml.jackson.annotation.JsonProperty("media") final serializers.dslplatform.media.Media media,
			@com.fasterxml.jackson.annotation.JsonProperty("images") final java.util.List<serializers.dslplatform.media.Image> images) {
		
		this.media = media == null ? new serializers.dslplatform.media.Media() : media;
		this.images = images == null ? new java.util.ArrayList<serializers.dslplatform.media.Image>() : images;
	}
	...
	public static com.dslplatform.client.json.JsonReader.ReadJsonObject<MediaContent> JSON_READER = new com.dslplatform.client.json.JsonReader.ReadJsonObject<MediaContent>() {
		@Override
		public MediaContent deserialize(final com.dslplatform.client.json.JsonReader reader, final com.dslplatform.patterns.ServiceLocator locator) throws java.io.IOException {
